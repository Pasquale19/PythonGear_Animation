...
#video_files = [    "animation1-converted.mp4",    "animation2-converted.mp4","animation3-converted.mp4","animation4-converted.mp4"]
# Define the output directory and output video file
output_directory = os.path.expanduser("~/Videos")
output_video = os.path.join(output_directory, "merged5.mp4")
...
#command
#ffmpeg -f concat -safe 0 -i mylist.txt -c copy -y mergedfile.mp4